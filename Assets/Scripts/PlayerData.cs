...
{
	[MenuItem("Assets/Trash Dash Debug/Clear Save")]
    static public void ClearSave()
    {
        File.Delete(Application.persistentDataPath + "/save.bin");
    }

    [MenuItem("Assets/Trash Dash Debug/Give 1000000 fishbones and 1000 premium")]
    ...
    [MenuItem("Assets/Trash Dash Debug/Give 10 Consumables of each types")]
